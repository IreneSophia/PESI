...
The PESI project focuses on "Perception of nonverbal social interaction in people with and without autism". Specifically, autistic and non-autistic comparison observers watched 64 silent videos of dyadic conversations between two non-autistic or one autistic and one non-autistic adult. All observers were adults. These videos were 10 seconds of longer conversations and either portrayed moments of high or low interpersonal synchrony (IPS) of movement. The videos only showed outlines of the dyad to direct the focus on the movement. During the video presentation, observers' gaze is tracked and after each video they are asked to rate how comfortable they imagine this interaction to be. 
