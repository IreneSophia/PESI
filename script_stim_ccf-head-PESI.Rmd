...
write_csv(vid_sel %>% select(context, dyad, winst, winen, frame_sta, frame_end), file="PESI_videosel_230222.csv")
write_csv(vid_sel, file="PESI_videosel-full_230222.csv")
